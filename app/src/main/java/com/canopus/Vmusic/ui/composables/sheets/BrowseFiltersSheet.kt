...
package com.canopus.Vmusic.ui.composables.sheets
...
import com.canopus.Vmusic.viewmodel.state.SortOrder
import com.canopus.Vmusic.viewmodel.state.VideoSortField
...
fun BrowseFiltersSheet(
    ...
    Column(
        ...
        val currentViewPresetDisplay by remember(tempFilters, organizationsForDropdown) {
            derivedStateOf {
                val orgDisplayPart = if (tempFilters.selectedOrganization != null) {
                    val orgName =
                        organizationsForDropdown.find { it.second == tempFilters.selectedOrganization }?.first
                            ?: tempFilters.selectedOrganization!!
        ...
        ExposedDropdownMenuBox(
            ...
            ExposedDropdownMenu(
                expanded = viewPresetExpanded,
                onDismissRequest = { viewPresetExpanded = false }) {
        ...
        ExposedDropdownMenuBox(
            ...
            OutlinedTextField(
                value = tempFilters.sortField.displayName,
                onValueChange = {},
                readOnly = true,
                ...
                VideoSortField.entries.forEach { field ->
                    ...
                    if (isApplicable) {
                        DropdownMenuItem(text = { Text(field.displayName) }, onClick = {
                            ...
                            tempFilters =
                                tempFilters.copy(sortField = field, sortOrder = newSortOrder)
        ...
        Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.fillMaxWidth()) {
            SortOrder.entries.forEach { order ->
                Row(
                    Modifier
                        .clickable { tempFilters = tempFilters.copy(sortOrder = order) }

...
class PaletteExtractor @Inject constructor(
    ...
    suspend fun extractThemeFromUrl(
        ...
        try {
            val request = ImageRequest.Builder(context)
                ...
                ) // Slightly larger for better blur quality while keeping it fast
     ...
     */
    @ColorInt
    private fun getBestTextColorForBackground(

package com.canopus.Vmusic.util
...
private data class DescriptionContext(
...
object PlaylistFormatter {
    ...
    private object UserWeeklyFormatter : SgpFormatter {
        override fun getTitle(
            ...
            c: Context,
            n: (String?, String?) -> String?
        ) = c.getString(R.string.sgp_my_weekly_mix_title)
        ...
        override fun getDescription(
            ...
            c: Context,
            n: (String?, String?) -> String?
        ) = c.getString(R.string.sgp_my_weekly_mix_desc)
    }
    ...
    private object HistoryFormatter : SgpFormatter {
        override fun getTitle(
            ...
            c: Context,
            n: (String?, String?) -> String?
        ) = c.getString(R.string.sgp_history_title)
        ...
        override fun getDescription(
            ...
            c: Context,
            n: (String?, String?) -> String?
        ) = c.getString(R.string.sgp_history_desc)
    }
    ...
    private object HotFormatter : SgpFormatter {
        override fun getTitle(
            ...
            c: Context,
            n: (String?, String?) -> String?
        ) = c.getString(R.string.sgp_hot_title)
        ...
        override fun getDescription(
            ...
            c: Context,
            n: (String?, String?) -> String?
        ) = c.getString(R.string.sgp_hot_desc)
    }

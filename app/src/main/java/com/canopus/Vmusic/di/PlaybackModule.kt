...
import com.canopus.Vmusic.playback.data.mapper.MediaItemMapper
import com.canopus.Vmusic.playback.data.model.PlaybackDao
import com.canopus.Vmusic.playback.data.preload.PreloadConfiguration
import com.canopus.Vmusic.playback.data.preload.PreloadStatusController
import com.canopus.Vmusic.playback.data.queue.ShuffleOrderProvider
import com.canopus.Vmusic.playback.data.repository.HolodexStreamResolverRepositoryImpl
import com.canopus.Vmusic.playback.data.source.HolodexResolvingDataSource
import com.canopus.Vmusic.playback.data.source.StreamResolutionCoordinator
import com.canopus.Vmusic.playback.domain.repository.StreamResolverRepository
import com.canopus.Vmusic.playback.player.Media3PlayerController
import com.canopus.Vmusic.playback.player.PlaybackController
import com.canopus.Vmusic.viewmodel.autoplay.AutoplayItemProvider
...
object PlaybackModule {
    ...
    @Provides
    @Singleton
    fun provideStreamResolverRepository(repo: com.canopus.Vmusic.data.repository.YouTubeStreamRepository): StreamResolverRepository {
    ...
    fun providePlaybackController(
        ...
        mediaControllerManager: com.canopus.Vmusic.playback.player.MediaControllerManager
    ): PlaybackController {

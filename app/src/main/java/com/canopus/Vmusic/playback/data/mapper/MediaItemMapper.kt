package com.canopus.Vmusic.playback.data.mapper
...
class MediaItemMapper @Inject constructor(
    ...
    fun toMedia3MediaItem(playbackItem: PlaybackItem): MediaItem {
        ...
        val highResArtworkUriString =
            getHighResArtworkUrl(playbackItem.artworkUri, imageQualityKey = imageQualityPref)

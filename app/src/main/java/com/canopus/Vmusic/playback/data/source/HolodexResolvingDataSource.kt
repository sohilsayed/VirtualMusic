...
import com.canopus.Vmusic.data.repository.StreamUrlRepository // Changed Import
...
class HolodexResolvingDataSource @Inject constructor(
    ...
    override fun resolveDataSpec(dataSpec: DataSpec): DataSpec {
        ...
        if (uri.scheme == "holodex" && uri.host == "resolve") {
            ...
            val videoIdForNetwork =
                if (rawId.contains("_") && rawId.substringAfterLast("_").all { it.isDigit() }) {
